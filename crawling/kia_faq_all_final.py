...
# 전체 탭 이동
kia_btn = driver.find_element(By.XPATH, '//*[@id="tab-list"]/li[2]/button')
kia_btn.click()
time.sleep(1)
...
def data_kia():
    ...
    for item in items:
        ...
        if button.get_attribute("aria-expanded") == "false":
            button.click()
            time.sleep(0.5)
        answer_elems = item.find_elements(By.CSS_SELECTOR, "div.faqinner__wrap p, div.faqinner__wrap li")

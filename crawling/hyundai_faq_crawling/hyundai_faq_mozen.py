...
# 3. 차량구매 탭 클릭 (필요x)
# hcar_buy_btn = driver.find_element(By.XPATH, '//*[@id="app"]/div[3]/section/div[2]/div/div[2]/section/div/div[1]/div[1]/ul/li[1]/button')
# hcar_buy_btn.click()
# time.sleep(2)

# 3. 모젠서비스 탭 클릭
hcar_mozen_btn = driver.find_element(By.XPATH, '//*[@id="app"]/div[3]/section/div[2]/div/div[2]/section/div/div[1]/div[1]/ul/li[5]/button')
hcar_mozen_btn.click()
time.sleep(2)
...
df.to_csv('hyundai_faq_mozen.csv', index=False, encoding='utf-8-sig')
print('@@@CSV 저장 완료!@@@')
